...
var base_search_url = "https://sfsfs.atlassian.net/rest/api/2/search?";
var maxResults = 1000;
var jiraIssueURL = "https://fsds.atlassian.net/browse/";


function jiraLogin() {
  var response = UrlFetchApp.fetch("https://dasdasdas.atlassian.net/rest/auth/1/session", options);
